        ...
        <div className="mt-7 bg-[var(--background-secondary)] border border-[var(--border-dividers)] rounded-xl shadow-sm">
          <div className="p-4 sm:p-7">
            ...
            <div className="mt-5">
              ...
              <div className="py-3 flex items-center text-xs text-[var(--text-muted)] uppercase before:flex-[1_1_0%] before:border-t before:border-[var(--border-dividers)] before:me-6 after:flex-[1_1_0%] after:border-t after:border-[var(--border-dividers)] after:ms-6">
                Or
              </div>
