            ...
            <header ref={navbarRef} className="fixed top-0 left-0 w-full bg-[#121212] border-b border-[#292929] z-50">
                <nav className="max-w-[85rem] mx-auto px-6 flex items-center justify-between py-3">
                    ...
                    <div className="hidden sm:flex items-center gap-6">
                        <Link to="/" className="relative text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium group">
                            Home
                            <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#4CAF50] transition-all duration-300 group-hover:w-full"></span>
                        </Link>
                        <Link to="/transaction" className="relative text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium group">
                            Transaction
                            <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#4CAF50] transition-all duration-300 group-hover:w-full"></span>
                        </Link>
                        ...
                        <Link to="/about" className="relative text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium group">
                            About Us
                            <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#4CAF50] transition-all duration-300 group-hover:w-full"></span>
                        </Link>
                    </div>
                    ...
                    {isOpen && (
                        ...
                        >
                            <div className="mobile-menu flex flex-col items-center py-4 gap-4">
                                <Link to="/" className="text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium">
                                    Home
                                </Link>
                                <Link to="/transaction" className="text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium">
                                    Transaction
                                </Link>
                                <Link to="/contactus" className="text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium">
                                    Contact Us
                                </Link>
                                <Link to="/work" className="text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium">
                                    Work
                                </Link>
                                <Link to="/blog" className="text-[#B0B0B0] hover:text-[#4CAF50] transition-all duration-300 font-medium">
                                    Blog
                                </Link>
